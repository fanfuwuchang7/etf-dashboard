...
ETFS = [
    ...
    ("sh515050", "5G通信"),
    ("sh513100", "纳指ETF"),
    ("sz159981", "有色期货"),   # 大成有色金属期货ETF: 跟踪上期有色金属期货指数(商品期货,非股票)
    ("sh513500", "标普500"),
    ("sz159928", "消费"),
    ("sh513180", "恒生科技"),
    ("sh512690", "白酒"),
    ...
    ("sh515790", "光伏"),
    ("sh515220", "煤炭"),
    ("sh516150", "稀土产业"),   # 嘉实: 中证稀土产业指数(930598)
    ("sh515210", "钢铁"),
    ("sz159870", "化工"),
    ("sz159825", "农业"),
    ("sz159996", "家电"),
    ...
    ("sh516950", "基建"),
    ("sz159611", "电力"),
    ("sh515980", "人工智能"),   # 华富: 中证人工智能产业指数(931071, SmartBeta)
    ("sh562500", "机器人"),
    ("sh515230", "软件"),
    ("sh512980", "传媒"),
    ("sh513520", "日经225"),
    ...
    ("sz159997", "电子"),
    ("sh515400", "大数据"),
    ("sh515070", "人工智能"),   # 华夏: 中证人工智能主题指数(930713)
    ("sh516260", "物联网"),
    ("sz159841", "证券"),
    ("sh510230", "金融"),
    ("sh512290", "生物医药"),
    ...
    ("sz159865", "养殖"),
    ("sh561360", "石油"),
    ("sh512400", "有色金属"),   # 南方: 中证申万有色金属指数(股票ETF)
    ("sh516780", "稀土产业"),   # 华泰柏瑞: 中证稀土产业指数(与516150同指数,不同产品)
    ("sh518800", "黄金"),
    ("sh517520", "黄金股"),
    ("sh561330", "矿业"),
    ("sh562800", "稀有金属"),
