...
ETFS = [
    ("sh510300", "沪深300ETF-华泰柏瑞"),
  ("sh510050", "上证50ETF-华夏"),
  ("sh510500", "中证500ETF-南方"),
  ("sh512100", "中证1000ETF-南方"),
  ("sz159915", "创业板ETF-易方达"),
  ("sh588000", "科创50ETF-华夏"),
  ("sh588080", "科创板50ETF-易方达"),
  ("sh588030", "科创100ETF-博时"),
  ("sh588900", "科创100ETF南方"),
  ("sh588230", "科创200ETF-华泰柏瑞"),
  ("sh588270", "科创200ETF易方达"),
  ("sh589220", "科创200ETF国泰"),
  ("sh588700", "科创医药ETF嘉实"),
  ("sh588130", "科创医药ETF华夏"),
  ("sz159919", "沪深300ETF-嘉实"),
  ("sz159922", "中证500ETF-嘉实"),
  ("sz159845", "中证1000ETF-华夏"),
  ("sz159949", "创业板50ETF-华安"),
  ("sz159901", "深证100ETF-易方达"),
  ("sh510180", "上证180ETF-华安"),
  ("sh510330", "沪深300ETF-华夏"),
  ("sh510310", "沪深300ETF-易方达"),
  ("sh563000", "中证A50ETF-平安"),
  ("sh563300", "中证A500ETF-摩根"),
  ("sh512880", "证券ETF-国泰"),
  ("sh512800", "银行ETF-华宝"),
  ("sh512200", "房地产ETF-南方"),
  ("sh515060", "房地产ETF华夏"),
  ("sh512070", "证券保险ETF-易方达"),
  ("sh510230", "金融ETF-国泰"),
  ("sz159928", "消费ETF-汇添富"),
  ("sh510630", "消费ETF-华夏"),
  ("sz159936", "可选消费ETF-广发"),
  ...
  ("sz159995", "芯片ETF-华夏"),
  ("sh588200", "科创芯片ETF-嘉实"),
  ("sz159516", "半导体材料设备ETF-国泰"),
  ("sh561980", "中证半导体产业ETF-华安"),
  ("sz159627", "存储ETF-嘉实"),
  ("sz159819", "人工智能ETF-易方达"),
  ("sz562500", "机器人ETF-华夏"),
  ("sh512660", "军工ETF-国泰"),
  ("sh512670", "国防ETF-鹏华"),
  ("sh512710", "军工龙头ETF-富国"),
  ...
  ("sz159869", "游戏ETF-华夏"),
  ("sz159707", "地产ETF-华宝"),
  ("sz159201", "自由现金流ETF-国泰"),
  ("sh515000", "科技ETF-华宝"),
  ("sz159792", "港股通互联网ETF-富国"),
  ("sz159735", "港股消费ETF银华"),
  ("sz159636", "港股通科技ETF-景顺长城"),
  ("sz159326", "电网设备ETF-华夏"),
  ("sz159381", "创业板人工智能ETF-南方"),
  ("sz158008", "新能源电池ETF-华安"),
  ("sz159568", "港股创新药ETF-港股通"),
  ("sh513360", "教育ETF博时"),
  ("sz159892", "恒生医药ETF华夏"),
  ("sh513280", "恒生生物科技ETF汇添富"),
  ("sh513630", "港股红利ETF-摩根"),
  ("sz159547", "黄金股ETF-华夏"),
  ("sh515450", "红利低波50ETF-南方"),
  ("sz159563", "创业板综ETF-万家"),
  ("sz158001", "价值ETF-嘉实"),
  ("sz159259", "成长ETF-易方达"),
  ("sz159581", "红利ETF-万家中证"),
  ...
  ("sh512390", "低波ETF-平安"),
  ("sz159916", "基本面ETF-建信"),
  ("sh512890", "红利低波ETF-华泰柏瑞"),
  ("sh510880", "红利ETF-华泰柏瑞"),
  ("sh513130", "恒生科技ETF-华泰柏瑞"),
  ("sh513180", "恒生科技指数ETF-华夏"),
  ("sz159920", "恒生ETF-华夏"),
  ("sh513050", "中概互联网ETF-易方达"),
  ("sh513100", "纳指ETF-国泰"),
  ("sh513500", "标普500ETF-博时"),
  ...
  ("sz159997", "电子ETF-天弘"),
  ("sz159828", "医疗保健ETF-国泰"),
  ("sz159531", "中证2000ETF-南方"),
  ("sz159537", "北证50ETF-易方达"),
  ("sh588400", "双创50ETF-嘉实"),
  ("sh513520", "日经225ETF-华夏"),
  ("sh513030", "德国DAXETF-华安"),
  ("sz159985", "豆粕ETF-华夏"),
  ("sz159309", "油气资源ETF-汇添富"),
  ("sz159930", "能源ETF-汇添富"),
  ("sh561360", "石油ETF-国泰"),
  ("sz159697", "石油ETF-鹏华"),
  ("sz159981", "能源化工ETF建信"),
...
def fetch_from_tencent(code, datalen=400):
...
def fetch_from_eastmoney(code, datalen=400):
...
def fetch_from_tonghuashun(code, datalen=400, period=None):
...
def fetch_from_biying(code, datalen=400, period=None):
    """必盈API基金历史K线, 返回统一结构 [{day,open,high,low,close,volume}] 或 None

    字段: d交易时间(yyyy-MM-dd) o开盘 h最高 l最低 c收盘 v成交量
    """
...
def try_fetch(symbol, tries=2):
    ...
    sources = [
        ("新浪", lambda: fetch_kline(symbol)),
        ("腾讯", lambda: fetch_from_tencent(symbol)),
        ("东财", lambda: fetch_from_eastmoney(symbol)),
        ("同花顺", lambda: fetch_from_tonghuashun(symbol)),
        ("必盈", lambda: fetch_from_biying(symbol)),
    ]
